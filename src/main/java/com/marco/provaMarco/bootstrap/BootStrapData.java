...
public class BootStrapData implements CommandLineRunner {
    ...
    public BootStrapData(ICandidatoRepository candidatoRepository, ISecaoRepository secaoRepository, IUrnaRepository urnaRepository, IZonaRepositoty zonaRepositoty, IVotoRepository votoRepository, IVotoService votoService) {
...
//        urnaRepository.save(urnaNorte4);
        ...
        Secao secaoLeste1 = new Secao("Secao Leste 1", urnaLeste1);
        Secao secaoLeste2 = new Secao("Secao Leste 2", urnaLeste2);
...
//        secaoRepository.save(secaoNorte2);
        ...
        //Instancia Zonas
        Zona zonaLeste = new Zona("Zona Leste 1",secaoLeste1, urnaLeste1);
        Zona zonaLeste2 = new Zona("Zona Leste 2",secaoLeste2, urnaLeste2);
...
//        totalZonas.add(zonaNorte);
        ...
        zonaRepositoty.save(zonaLeste2);
//        zonaRepositoty.save(zonaNorte);

        //Instancia candidatos
        Candidato candidatoJose = new Candidato("Jose das Neves");
//        candidatoJose.setQuantidadeVotos(11);
        Candidato candidatoManoel = new Candidato("Manoel dos Campos");
...
//        secaoRepository.save(secaoNorte2);
        ...
        Voto votar1 = new Voto(zonaLeste.getId()
                , secaoLeste1.getId()
                , urnaLeste1.getId()
                , candidatoJose.getId()
                , 1L);
        ...
        Voto voto1 = new Voto(zonaLeste.getId(),
                                    secaoLeste1.getId(),
                                    urnaLeste1.getId(),
                                    candidatoJose.getId(),
                                    1L);

        Voto voto2 = new Voto(zonaLeste.getId(),
                secaoLeste1.getId(),
                urnaLeste1.getId(),
                candidatoJose.getId(),
                1L);

        Voto voto3 = new Voto(zonaLeste.getId(),
                secaoLeste1.getId(),
                urnaLeste1.getId(),
                candidatoJose.getId(),
                1L);

        Voto voto4 = new Voto(zonaLeste.getId(),
                secaoLeste2.getId(),
                urnaLeste1.getId(),
                candidatoManoel.getId(),
                1L);
        ...
        Boolean votei1 = votoService.votar(candidatoJose, voto1.getVotar());
        votoService.votar(candidatoJose, voto2.getVotar());
        votoService.votar(candidatoJose, voto3.getVotar());
        votoService.votar(candidatoManoel, voto4.getVotar());


        System.out.println("Quantidade de Votos: " + votoRepository.count());

        System.out.println("Votos por candidato Jose das Neves: " + candidatoRepository
                .findByName("Jose das Neves")
                .getQuantidadeVotos());
